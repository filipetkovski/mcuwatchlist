...
> = [
  ...
  ["what-if-s1", "What If...? (Season 1)", "tv", "2021-08-11", 300, "optional"],
  ...
  ["your-friendly-neighborhood-spider-man", "Your Friendly Neighborhood Spider-Man (Season 1)", "tv", "2025-01-29", 250, "optional"],
  ["moon-knight", "Moon Knight", "tv", "2022-03-30", 270, "optional"],
  ...
  ["ms-marvel", "Ms. Marvel", "tv", "2022-06-08", 240, "optional"],
  ["thor-love-and-thunder", "Thor: Love and Thunder", "movie", "2022-07-08", 119, "optional"],
  ["she-hulk", "She-Hulk: Attorney at Law", "tv", "2022-08-18", 300, "optional"],
  ["werewolf-by-night", "Werewolf by Night", "special", "2022-10-07", 53, "optional"],
  ...
  ["echo", "Echo", "tv", "2024-01-09", 220, "optional"],
  ["x-men-97", "X-Men '97 (Season 1)", "tv", "2024-03-20", 340, "unconfirmed"],
  ["x-men-2000", "X-Men (2000)", "movie", "2000-07-14", 104, "unconfirmed", { universe: "non_marvel_studios" }],
  ["x2", "X2: X-Men United", "movie", "2003-05-02", 134, "unconfirmed", { universe: "non_marvel_studios" }],
  ["x-men-first-class", "X-Men: First Class", "movie", "2011-06-03", 132, "optional", { universe: "non_marvel_studios" }],
  ["x-men-days-of-future-past", "X-Men: Days of Future Past", "movie", "2014-05-23", 132, "unconfirmed", { universe: "non_marvel_studios" }],
  ...
  ["daredevil-born-again-s1", "Daredevil: Born Again (Season 1)", "tv", "2025-03-04", 430, "optional"],
  ...
  ["marvel-zombies", "Marvel Zombies", "tv", "2025-09-24", 130, "optional"],
  ["wonder-man", "Wonder Man", "tv", "2026-01-27", 260, "unconfirmed"],
  ["daredevil-born-again-s2", "Daredevil: Born Again (Season 2)", "tv", "2026-03-24", 400, "unconfirmed"],
